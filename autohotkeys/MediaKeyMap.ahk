; MediaKeyMap - A Simple key remapping for media functions

; Edited from Rajat's script - Volume On-Screen-Display (OSD)
...
;HotKey, ^#Up, vol_MasterUp       ; Ctrl+Win+UpArrow
;HotKey, ^#Down, vol_MasterDown
;HotKey, ^#Right, vol_WaveUp
;HotKey, ^#Left, vol_WaveDown

; Native key mapping to HID
HotKey, ^#Up, media_vol_up
HotKey, ^#Down, media_vol_down
HotKey, ^#Right, media_play_next
HotKey, ^#Left, media_play_prev
HotKey, ^#Space, media_play_pause
